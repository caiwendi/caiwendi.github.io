...
\theta_{t+1, i} = \theta_{t,i} - \eta \ \cdot \ g_{t,i} \\传统的更新规则中，很显然，对于每一个 参数采用相同的学习速率进行阐述的更新
$$
...
$$
在Adagrad算法中，$\Delta \theta_t = - \frac{\eta}{\sqrt{G_t + \epsilon}} \odot g_t$，在Adadelta算法中我们将历史梯度和$G_{t, ii}$替换成历史梯度衰减平均值$E[g^2]_t$，具体如下:
$$
